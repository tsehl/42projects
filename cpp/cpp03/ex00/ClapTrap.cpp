...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/27 13:03:45 by thsehl            #+#    #+#             */
/*   Updated: 2023/06/27 13:03:48 by thsehl           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name) : _name(name), _hitPoints(10), _energyPoints(3), _attackDamage(5)
{
...
{
    std::cout << "Affectation operator called\n";
...
void ClapTrap::attack(const std::string& target)
{
    if (this->_attackDamage > 0 && this->_energyPoints > 0)
    {
        ...
        std::cout << this->_name << " doesnt have enough points of damage or points of energy to attack " << target << std::endl;
}
