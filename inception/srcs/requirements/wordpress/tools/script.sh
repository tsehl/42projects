...
if ! wp core is-installed --allow-root; then
	wp core install --url="thsehl.42.fr" --title="thsehl website" --admin_user="$WP_ADMIN" --admin_password="$WP_ADMIN_PASSWORD" --admin_email="thsehl@student.s19.be" --path="/var/www/wordpress" --allow-root
fi
