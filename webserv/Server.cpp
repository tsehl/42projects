...
Server::~Server() 
{
    //std:: << "Le serveur a été détruit." << std::endl;
}
...
std::string Server::getCode() const
{
    return _code;
}
...
void Server::setCode(std::string code)
{
    _code = code;
}
...
void Server::setRoot(std::string root)
{
 ...
 std::map<std::string, std::string> Server::getMapReturn() const
 {
    return _map_return;
 }

 void Server::setMapReturn(std::map<std::string, std::string> map_return)
 {
